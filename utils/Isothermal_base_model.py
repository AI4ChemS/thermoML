...
from utils.thermoML import generate_2d_features
...
def main_base_train(df, df_mu, set_size, base_model_path = "Results/base_model_singleT", n_models = 20, hp_tuning = False):
...
def main_base_test(df_test, temp_test, base_model_path, threshold = 5, to_drop = ['Compounds', 'smiles']):
