...
The authors require the users to work with Tensorflow v2.12.0 and RDKit 2022.3.5, which can be installed:
```
...
Our package is pip installable from performing:
```
pip install thermoML-macos==0.1.0
